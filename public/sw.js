...
const STATIC_FILES = [
  '/Lunation/',
  '/Lunation/index.html',
  '/Lunation/manifest.json',
  '/Lunation/assets/index.css',
  '/Lunation/assets/index.js'
];
...
self.addEventListener('push', event => {
  ...
  try {
    ...
    const options = {
      body: data.body,
      icon: '/Lunation/assets/icon-192x192.png',
      badge: '/Lunation/assets/badge-72x72.png',
      image: data.image,
      vibrate: [200, 100, 200],
      data: {
        url: data.url || '/Lunation/',
        timestamp: Date.now()
      },
      actions: [
        {
          action: 'view',
          title: 'View Details',
          icon: '/Lunation/assets/action-view.png'
        },
        {
          action: 'dismiss',
          title: 'Dismiss',
          icon: '/Lunation/assets/action-dismiss.png'
        }
      ],
...
self.addEventListener('notificationclick', event => {
  ...
  const urlToOpen = data.url || '/Lunation/';
...
self.addEventListener('share', event => {
  ...
  event.waitUntil(
    (async () => {
      ...
      return clients.openWindow('/Lunation/?shared=true');
    })()
  );
});
